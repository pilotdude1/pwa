<script lang="ts">
  ...
  export let editButtonTitle = null
  export let editLink = null
  ...
  <div class="w-full min-w-48">
      ...
      >
        ...
        {#if editable}
          <div>
            <button
              type="submit"
              class="ml-auto btn mt-3 min-w-[145px] {dangerous
                ? 'btn-error'
                : 'btn-success'}"
              disabled={loading}
            >
        ...
        {:else}
          ...
          <a href={editLink} class="mt-1">
            <button
              class="btn btn-outline {dangerous
                ? 'btn-error'
                : ''} min-w-[145px]"
            >
              {editButtonTitle}
    ...
    {:else}
      ...
      <a href="/dashboard/settings">
        <button class="btn btn-outline mt-3 min-w-[145px]">
          Return to Settings
        </button>
      </a>
    {/if}
